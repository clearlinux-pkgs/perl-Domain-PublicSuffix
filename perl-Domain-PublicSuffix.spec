...
Version  : 0.15
Release  : 12
URL      : https://cpan.metacpan.org/authors/id/N/NM/NMELNICK/Domain-PublicSuffix-0.15.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/N/NM/NMELNICK/Domain-PublicSuffix-0.15.tar.gz
...
License  : Artistic-1.0-Perl MPL-2.0-no-copyleft-exception
...
%prep
%setup -q -n Domain-PublicSuffix-0.15
cd ..
%setup -q -T -D -n Domain-PublicSuffix-0.15 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Domain-PublicSuffix-0.15/deblicense/
